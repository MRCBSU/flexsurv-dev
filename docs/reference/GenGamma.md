...
- sigma:
  ...
  [`dlnorm`](https://ehar.se/r/eha/reference/Lognormal.html), rather
  than the “scale” parameter of the gamma distribution
...
[`GenF`](http://chjackson.github.io/flexsurv-dev/reference/GenF.md),
[`Lognormal`](https://ehar.se/r/eha/reference/Lognormal.html),
[`GammaDist`](https://rdrr.io/r/stats/GammaDist.html),
[`Weibull`](https://ehar.se/r/eha/reference/Weibull.html).
